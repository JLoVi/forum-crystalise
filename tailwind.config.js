...
const colors = {
  ...
  // 'primary': '#9B7C56', // a color that is not in the material colors palette
  // 'primary': '#b4894b', // a color that is not in the material colors palette
  'primary': '#4A9EB7', // a color that is not in the material colors palette
  'accent': '#EFEFEF',
  'secondary': '#FFFFFF',
  // 'secondary': '#E0E0E0',
